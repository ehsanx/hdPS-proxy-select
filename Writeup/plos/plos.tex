...
\textbackslash textcolor\{red\}\{Bias-corrected coverage provides a more
accurate reflection of model reliability when bias is present. By
...
\item
  ...
  modeling {[}2,3{]}.
  \textcolor{red}{This threshold of 100 proxy variables has been used in the literature to balance model complexity and overfitting risk, while ensuring that a sufficient number of proxies are included to capture unmeasured confounding}
  {[}22{]}.
  \textcolor{red}{Our choice reflects a practical trade-off between dimensionality and computational feasibility.}
\item
...
{\centering \includegraphics{plos_files/figure-latex/unnamed-chunk-5-1} 

}

\caption{Computing time for the real-world analysis for each algorithm under consideration. The analysis is based on data from the National Health and Nutrition Examination Survey (NHANES) for the years 2013-2018.\label{fig:computing-time}}\label{fig:unnamed-chunk-5}
\end{figure}
...
\textcolor{red}{multiple treatment settings, and data with substantial measurement error,}
...
\textcolor{red}{Analysis codes are provided in https://github.com/ehsanx/hdPS-proxy-select-codes}.
