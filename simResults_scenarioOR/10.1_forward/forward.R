...
for (i in (b+1):a) {
  ...
  save_dir <- "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenarioOR/10.1_forward/"
...
save(RD_forward, num.proxy_forward, avg.num.proxy_forward,
     file = "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenarioOR/10.1_forward/forward.RData")
