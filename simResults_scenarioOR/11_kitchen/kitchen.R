...
save_dir_success <- paste0(path0, "simResults_scenarioOR/11_kitchen/success/")
save_dir_unsuccess <- paste0(path0, "simResults_scenarioOR/11_kitchen/unsuccess/")
...
for (i in a0:a) {
  ...
  path <- paste0(path0, "simData/scenarioOR/data_", i, ".rds")
  data <- readRDS(path)
  ...
  #   
  #   #save_dir <- paste0(path0, "simResults_scenarioOR/11_kitchen/unsuccess/")
 ...
 iteration <- i
    ...
    #save_dir <- paste0(path0, "simResults_scenarioOR/11_kitchen/success/")
...
save(RD_kitchen, num.proxy_kitchen, avg.num.proxy_kitchen, err_ratio, RD_kitchen_no.error, 
     file = paste0(path0, "simResults_scenarioOR/11_kitchen/kitchen.RData"))