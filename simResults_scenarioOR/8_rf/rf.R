...
for (i in (b+1):a) {
  ...
  RD_rf_OR[i-b,] <- sum.RD_rf
  rownames(RD_rf_OR)[i-b] <- paste0("data.", i, "_rf")
  ...
  save_dir <- "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenarioOR/8_rf/"
...
save(RD_rf_OR, num.proxy_rf, avg.num.proxy_rf,
