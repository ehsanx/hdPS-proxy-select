...
for (i in 1:a) {
  ...
  save_dir <- "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenario/3_lasso/"
...
save(RD_lasso, num.proxy_lasso, avg.num.proxy_lasso,
     file = "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenario/3_lasso/lasso.RData")
