...
for (i in 1:a) {
  ...
  if (class(hybrid.list) == "character") {
    ...
    save_dir <- "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenario/2_hybrid/"
...
save(RD_hybrid, num.proxy_hybrid, avg.num.proxy_hybrid, err_ratio, RD_hybrid_no.error, 
     file = "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenario/2_hybrid/hybrid.RData")
