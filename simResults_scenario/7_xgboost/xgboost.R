...
for (i in 1:a) {
  ...
  save_dir <- "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenario/7_xgboost/"
...
save(RD_xgboost, num.proxy_xgboost, avg.num.proxy_xgboost,
     file = "/scratch/st-mekarim-1/leiyang1/hdPS_ProxySelect/simResults_scenario/7_xgboost/xgboost.RData")
