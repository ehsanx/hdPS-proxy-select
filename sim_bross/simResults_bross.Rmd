...
# check RD & SE by bross for each data, print:
#   sum.RD_bross.n, sum.RD_bross.ER.n, or sum.RD_bross.OR.n
#   where "n" is a number ranges from 1 to 1000
#   e.g.
sum.RD_bross.1
sum.RD_bross.ER.2

# check proxy selected by bross for each data, print:
#   proxy_bross.n, proxy_bross.ER.n, or proxy_bross.OR.n
#   where "n" is a number ranges from 1 to 1000
#   e.g.
proxy_bross.1
proxy_bross.ER.5
