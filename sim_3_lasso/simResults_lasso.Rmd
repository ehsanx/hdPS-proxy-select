...
RD_lasso <- data.frame(RD = numeric(), SE = numeric())
...
for (i in 1:a) {
  ...
  num.proxy_lasso.i <- paste0("num.proxy_lasso.", i)
  assign(num.proxy_lasso.i, length(proxy_lasso))
...
for (i in 1:a) {
  ...
  num.proxy_lasso <- c(num.proxy_lasso, length(proxy_lasso))
  names(num.proxy_lasso)[i+a] <- paste0("ER.data.", i, "_lasso")
  
  proxy_lasso.i <- paste0("proxy_lasso.ER.", i)
  assign(proxy_lasso.i, proxy_lasso)
  num.proxy_lasso.i <- paste0("num.proxy_lasso.ER.", i)
  assign(num.proxy_lasso.i, length(proxy_lasso))
...
for (i in 1:a) {
  ...
  num.proxy_lasso <- c(num.proxy_lasso, length(proxy_lasso))
  names(num.proxy_lasso)[i+2*a] <- paste0("OR.data.", i, "_lasso")
  
  proxy_lasso.i <- paste0("proxy_lasso.OR.", i)
  assign(proxy_lasso.i, proxy_lasso)
  num.proxy_lasso.i <- paste0("num.proxy_lasso.OR.", i)
  assign(num.proxy_lasso.i, length(proxy_lasso))
...
num.proxy_lasso
mean(num.proxy_lasso[complete.cases(num.proxy_lasso)])
```
...
# check number of proxy selected by lasso for each data, print:
#   num.proxy_lasso.n, num.proxy_lasso.ER.n, or num.proxy_lasso.OR.n
#   where "n" is a number ranges from 1 to 1000
#   e.g.
num.proxy_lasso.1
num.proxy_lasso.OR.3
```
