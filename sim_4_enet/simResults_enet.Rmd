...
for (i in 1:a) {
  ...
  num.proxy_enet.i <- paste0("num.proxy_enet.", i)
  assign(num.proxy_enet.i, length(proxy_enet))
...
for (i in 1:a) {
  ...
  num.proxy_enet <- c(num.proxy_enet, length(proxy_enet))
  names(num.proxy_enet)[i+a] <- paste0("data.", i, "_enet")
  
  proxy_enet.i <- paste0("proxy_enet.ER.", i)
  assign(proxy_enet.i, proxy_enet)
  num.proxy_enet.i <- paste0("num.proxy_enet.ER.", i)
  assign(num.proxy_enet.i, length(proxy_enet))
...
for (i in 1:a) {
  ...
  num.proxy_enet <- c(num.proxy_enet, length(proxy_enet))
  names(num.proxy_enet)[i+2*a] <- paste0("data.", i, "_enet")
  
  proxy_enet.i <- paste0("proxy_enet.OR.", i)
  assign(proxy_enet.i, proxy_enet)  
  num.proxy_enet.i <- paste0("num.proxy_enet.OR.", i)
  assign(num.proxy_enet.i, length(proxy_enet))
...
num.proxy_enet
mean(num.proxy_enet[complete.cases(num.proxy_enet)])
```
...
# check number of proxy selected by enet for each data, print:
#   num.proxy_enet.n, num.proxy_enet.ER.n, or num.proxy_enet.OR.n
#   where "n" is a number ranges from 1 to 1000
#   e.g.
num.proxy_enet.1
num.proxy_enet.OR.4
